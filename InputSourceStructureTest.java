...
public class InputSourceStructureTest {
    ...
    public void fieldIsInteractive() {
        it.hasField("isInteractive", ofType("boolean"))
    ...
    @Test
    public void fieldBr() {
        it.hasField("br", ofType("java.io.BufferedReader"))
    ...
    public void fieldInputs() {
        it.hasField("inputs", ofType("array of int"))
            .thatIs(INSTANCE_LEVEL, MODIFIABLE, VISIBLE_TO_NONE)
            .thatHasNo(GETTER, SETTER);
    }
    ...
    public void fieldInputIdx() {
        it.hasField("inputIdx", ofType("int"))
            .thatIs(INSTANCE_LEVEL, MODIFIABLE, VISIBLE_TO_NONE)
            .thatHasNo(GETTER, SETTER);
    }
