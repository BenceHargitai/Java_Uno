...
public class GameStructureTest {
    ...
    public void fieldDeck() {
        it.hasField("deck", ofType("LinkedList"))
    ...
    public void fieldPlayers() {
        it.hasField("players", ofType("List"))
            .thatIs(INSTANCE_LEVEL, MODIFIABLE, VISIBLE_TO_PACKAGE)
            .thatHas(GETTER)
            .thatHasNo(SETTER);
    }
    ...
    public void fieldCurrentCard() {
        it.hasField("currentCard", ofType("uno.util.Card"))
            .thatIs(INSTANCE_LEVEL, MODIFIABLE, VISIBLE_TO_PACKAGE)
            .thatHasNo(GETTER, SETTER);
    }
    ...
    public void fieldCurrentPlayerIdx() {
        it.hasField("currentPlayerIdx", ofType("int"))
            .thatIs(INSTANCE_LEVEL, MODIFIABLE, VISIBLE_TO_PACKAGE)
            .thatHasNo(GETTER, SETTER);
    }
    ...
    public void fieldIsForward() {
        it.hasField("isForward", ofType("boolean"))
            .thatIs(INSTANCE_LEVEL, MODIFIABLE, VISIBLE_TO_PACKAGE)
            .thatHasNo(GETTER, SETTER);
    }
    ...
    public void fieldIsOn() {
        it.hasField("isOn", ofType("boolean"))
            .thatIs(INSTANCE_LEVEL, MODIFIABLE, VISIBLE_TO_PACKAGE)
            .thatHasNo(GETTER, SETTER);
    }
    ...
    public void fieldInputSource() {
        it.hasField("inputSource", ofType("uno.util.InputSource"))
            .thatIs(INSTANCE_LEVEL, MODIFIABLE, VISIBLE_TO_PACKAGE)
            .thatHasNo(GETTER, SETTER);
    }
